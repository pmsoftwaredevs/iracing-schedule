...
series' effective license tier, app/parsers/schedule_pdf.py) and the browse page
(rendering a badge + filter per tier, app/main.py / app/templates/index.html), so
the ladder order and colors live in exactly one place.
